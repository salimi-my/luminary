                ...
                <div class="flex items-center">
                    <form method="get" action="{{ route('search') }}">
                        <input name="search" value="{{ request()->get('search') }}"
                            class="block w-full rounded-md border-0 px-3.5 py-2 t0ext-gray-900 shadow-sm ring-1 ring-inset ring-yellow-300 placeholder:text-gray-400 focus:ring-2 focus:ring-primary focus:ring-inset sm:text-sm sm:leading-6 font-medium"
                            placeholder="Search..." />
                    </form>
