    ...
    <form wire:submit.prevent="createComment" x-data="{
        ...
        <div :class="isEdit || focused ? 'flex items-center gap-2' : 'hidden'">
            <button wire:loading.remove type="submit"
                class="rounded-md bg-primary px-3.5 py-2 text-center text-sm font-semibold shadow-sm hover:bg-yellow-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-600">
                Submit
            </button>
