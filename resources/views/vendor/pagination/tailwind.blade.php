...
<nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
    <div class="flex justify-between flex-1 sm:hidden">
        ...
        <span rel="prev"
            class="h-10 w-10 font-semibold text-gray-800 text-sm flex items-center justify-center mr-3 opacity-50">
        ...
        @else
        <span rel="next"
            class="h-10 w-10 font-semibold text-gray-800 hover:text-gray-900 text-sm flex items-center justify-center ml-3 opacity-50">
            Next
            <i class="fa-solid fa-arrow-right ml-2"></i>
        </span>
        @endif
